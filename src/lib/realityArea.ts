...
export interface RealityFounderCovenantReviewQueueActivitySignalStatusCounts {
  total: number
  met: number
  watch: number
  manualReview: number
...
export interface RealityFounderCovenantReviewQueueDashboard {
  ...
  totals: {
    ...
    blockers: number
    activitySignalStatusCounts: RealityFounderCovenantReviewQueueActivitySignalStatusCounts
  }
...
function isRealityFounderCovenantReviewQueueTotals(
  ...
  return isRecord(value) &&
    ...
    isRealityFounderCovenantReviewQueueActivitySignalStatusCounts(value.activitySignalStatusCounts)
}
...
function isRealityFounderCovenantReviewQueueActivitySignalStatusCounts(
  value: unknown,
): value is RealityFounderCovenantReviewQueueActivitySignalStatusCounts {
  return isRecord(value) &&
    typeof value.total === 'number' &&
    typeof value.met === 'number' &&
    typeof value.watch === 'number' &&
    typeof value.manualReview === 'number'
}
