...
export interface RealityFounderCovenantReviewQueueChecklistStatusCounts {
  total: number
  met: number
  watch: number
  manualReview: number
...
export interface RealityFounderCovenantReviewQueueDashboard {
  ...
  totals: {
    ...
    blockers: number
    reviewChecklistStatusCounts: RealityFounderCovenantReviewQueueChecklistStatusCounts
  }
...
function isRealityFounderCovenantReviewQueueTotals(
  ...
  return isRecord(value) &&
    ...
    isRealityFounderCovenantReviewQueueChecklistStatusCounts(value.reviewChecklistStatusCounts)
}
...
function isRealityFounderCovenantReviewQueueChecklistStatusCounts(
  value: unknown,
): value is RealityFounderCovenantReviewQueueChecklistStatusCounts {
  return isRecord(value) &&
    typeof value.total === 'number' &&
