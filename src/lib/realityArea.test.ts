...
function serverDashboard(): RealityAreaDashboard {
  return {
    ...
    simPopulation: 1,
    realPopulation: 1,
    demand: { water: 1, food: 2, housing: 0, clinic: 0, insurance: 2, workers_hall: 0 },
    simDemand: { water: 1, food: 1, housing: 0, clinic: 0, insurance: 1, workers_hall: 0 },
    realDemand: { water: 0, food: 1, housing: 0, clinic: 0, insurance: 1, workers_hall: 0 },
    supply: { water: 1, food: 0, housing: 0, clinic: 0, insurance: 0, workers_hall: 0 },
    capacity: { water: 24, food: 0, housing: 0, clinic: 0, insurance: 0, workers_hall: 0 },
    shortage: { water: 0, food: 2, housing: 0, clinic: 0, insurance: 2, workers_hall: 0 },
    licenseSlots: { water: 1, food: 1, housing: 1, clinic: 0, insurance: 0, workers_hall: 0 },
    saturation: { water: 1, food: 0, housing: 0, clinic: 0, insurance: 0, workers_hall: 0 },
    licenses: {
      ...
      workers_hall: { slots: 0, used: 0, remaining: 0, saturation: 0 },
    },
    ledger: {
      transactionCount: 2,
      totalsByKind: {
