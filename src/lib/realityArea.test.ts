...
function serverFounderCovenantReviewQueue(): RealityFounderCovenantReviewQueueDashboard {
  ...
  return {
    ...
    totals: {
      ...
      probationApprovals: review.reviewQueue.pendingApprovalKinds.filter((kind) => kind === 'start_probation').length,
      replacementApprovals: review.reviewQueue.pendingApprovalKinds.filter((kind) => kind === 'recommend_replacement').length,
    ...
    items: [{
      ...
      weeklyReviewDue: review.reviewSchedule.weeklyReviewDue,
      monthlyReviewDue: review.reviewSchedule.monthlyReviewDue,
