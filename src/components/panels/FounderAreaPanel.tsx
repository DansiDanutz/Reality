            ...
            {dashboard.founderCovenant.latestReview && (
              <div className="item founder-covenant-latest-review" aria-label="Latest founder review evidence">
                <div className="item-info">
                  ...
                  <span className="item-desc">
                    {founderCovenantReviewDecisionDetailText(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                    {founderCovenantReviewSnapshotSummary(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                    {founderCovenantReviewActivityDetailText(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                  ...
                  <span className="item-desc">
                    {founderCovenantReviewInputDetailText(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                    {founderCovenantStageSnapshotSummary(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                    {founderCovenantStageDetailText(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                  ...
                  <span className="item-desc">
                    {founderCovenantReviewCadenceDetailText(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                    {founderCovenantReviewActionSummary(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                    {founderCovenantReviewActionDetailText(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                    {founderCovenantReviewApprovalSummary(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                    {founderCovenantReviewApprovalDetailText(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                    {founderCovenantReviewApprovalBlockerSummary(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                    {founderCovenantReviewSignalSummary(dashboard.founderCovenant.latestReview)}
                  </span>
                  <span className="item-desc">
                    {founderCovenantReviewSignalDetailText(dashboard.founderCovenant.latestReview)}
                  </span>
                </div>
                ...
                {dashboard.founderCovenant.reviewHistory.map((entry) => (
                  <li className="item founder-covenant-history-item" key={entry.id}>
                    <div className="item-info">
                      ...
                      <span className="item-desc">{founderCovenantReviewDecisionDetailText(entry)}</span>
                      <span className="item-desc">{founderCovenantReviewSnapshotSummary(entry)}</span>
                      <span className="item-desc">{founderCovenantReviewActivityDetailText(entry)}</span>
                      ...
                      <span className="item-desc">{founderCovenantReviewActionDetailText(entry)}</span>
                      <span className="item-desc">{founderCovenantReviewApprovalSummary(entry)}</span>
                      <span className="item-desc">{founderCovenantReviewApprovalDetailText(entry)}</span>
                      <span className="item-desc">{founderCovenantReviewApprovalBlockerSummary(entry)}</span>
                      <span className="item-desc">{founderCovenantReviewSignalSummary(entry)}</span>
                      <span className="item-desc">{founderCovenantReviewSignalDetailText(entry)}</span>
                    </div>
