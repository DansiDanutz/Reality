...
describe('FounderCovenantOperatorPanel', () => {
  ...
  test('renders an initial queue through the evidence-only queue panel', () => {
    ...
    expect(html).toContain('class="founder-ledger-chip stable" title="1 founder in current page · 1 never · 0 stale · 0 fresh"><span>View</span><strong>All</strong>')
    ...
    expect(html).toContain('class="founder-ledger-chip critical" title="1 founder in current page · 1 never · 0 stale · 0 fresh"><span>Slice</span><strong>1 never</strong>')
    ...
    expect(html).toContain('title="1 founder in current page · 1 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="1 founder never reviewed · 1 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="0 founders stale weekly due · 0 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="0 founders stale monthly due · 0 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="0 founders weekly review due · 0 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="0 founders monthly review due · 0 never · 0 stale · 0 fresh"')
    ...
    expect(html).toContain('title="1 founder need manual review · 1 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="1 founder need manual evidence · 1 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="1 founder overdue · 1 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="1 founder blocked by workflow gaps · 1 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="1 founder hospitalized · 1 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="1 founder inactive · 1 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="1 founder in debt risk · 1 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="1 founder at risk · 1 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="1 founder Telegram ready · 1 never · 0 stale · 0 fresh"')
    expect(html).toContain('title="0 founders with scan anomalies · 0 never · 0 stale · 0 fresh"')
    expect(html).toContain('Inactive')
    expect(html).toContain('Debt')
    expect(html).toContain('Risk')
    expect(html).toContain('Telegram')
    expect(html).toContain('class="btn small primary" title="1 founder in current page · 1 never · 0 stale · 0 fresh" type="button">All</button>')
  ...
  test('surfaces founder-state and cadence chips in the operator queue summary strip', () => {
    ...
    expect(html).toContain('class="founder-ledger-chip stable" title="Founder state: inactive 0 · usefulness gaps 0 · build gaps 0 · staffing gaps 0 · debt risk 0 · hospitalized 0 · at risk 0"><span>Useful gaps</span><strong>0</strong>')
    expect(html).toContain('class="founder-ledger-chip stable" title="Founder state: inactive 0 · usefulness gaps 0 · build gaps 0 · staffing gaps 0 · debt risk 0 · hospitalized 0 · at risk 0"><span>Build gaps</span><strong>0</strong>')
    expect(html).toContain('class="founder-ledger-chip stable" title="Founder state: inactive 0 · usefulness gaps 0 · build gaps 0 · staffing gaps 0 · debt risk 0 · hospitalized 0 · at risk 0"><span>Staff gaps</span><strong>0</strong>')
  ...
  test('derives coverage preset context from filter and sort state', () => {
    ...
    expect(founderCovenantOperatorQueueReplacementRiskSummary({
      items: operatorQueue().items,
    })).toBe('Replacement risk: 1 founder · 1 inactive · 1 manual review')
...
function operatorQueue(): RealityFounderCovenantReviewQueueDashboard {
  return {
    ...
    totals: {
      ...
      nextEvidenceFounders: 1,
      nextBlockedFounders: 0,
      nextOverdueFounders: 0,
      nextRecordFounders: 0,
      nextMonitorFounders: 0,
      lowScoreFounders: 1,
      inactiveFounders: 1,
      manualReviewQueueFounders: 1,
