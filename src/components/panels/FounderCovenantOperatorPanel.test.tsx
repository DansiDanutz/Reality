...
describe('FounderCovenantOperatorPanel', () => {
  ...
  test('renders an initial queue through the evidence-only queue panel', () => {
    ...
    expect(html).toContain('All 1 · Never 1 · Stale 0 · Stale week 0 · Stale month 0 · Fresh 0 · Manual 1 · Evidence 1 · Next evidence 1 · Next blocked 0 · Next overdue 0 · Overdue 1 · Blocked 1 · Hospital 1 · Scan 0')
