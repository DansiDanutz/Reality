...
describe('FounderCovenantOperatorPanel', () => {
  ...
  test('renders an initial queue through the evidence-only queue panel', () => {
    ...
    expect(html).toContain('1 founder · 3 review inputs: 0 captured, 0 watch, 3 manual · 1 manual review · 1 overdue · 1 hospitalized · 1 indebted · $350 debt · more available')
