...
export default function FounderCovenantOperatorPanel({
  ...
  const copyQueueViewContext = async () => {
    ...
    const reviewProvenanceSummary = queue ? founderCovenantOperatorQueueReviewProvenanceSummary(queue, queueFilter, queueSort) : null
  ...
  const copyManualReviewTelegramDraft = async () => {
    ...
    try {
      ...
      setLastCopiedQueueView({
        ...
        telegramReviewReference: queueReviewReferenceText(draft.reviewId),
  ...
  const copyFounderWarningTelegramDraft = async () => {
    ...
    try {
      ...
      setLastCopiedQueueView({
        ...
        telegramReviewReference: queueReviewReferenceText(request.reviewId),
        reviewProvenanceSummary: null,
        focusSummary,
        escalationSummary,
        activitySummary,
        ...
        <>
          ...
          <div className="founder-ledger-summary" aria-label="Founder operator queue view summary">
            ...
            >
              ...
              <strong>{queue.totals.probationRiskFounders}</strong>
            </span>
            <span
              className={`founder-ledger-chip ${
            ...
            >
              ...
              <strong>{queue.totals.replacementRiskFounders}</strong>
            </span>
            <span
