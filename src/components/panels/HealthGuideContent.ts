...
export const HEALTH_GUIDE_SECTIONS: GuideSection[] = [
  {
    icon: '💧',
    title: 'Water',
    reality:
  ...
  },
  {
    ...
    inGame:
      'HP follows the same triage: dehydration drains it fastest (−6/h), then starvation or exhaustion (−3/h). Kept fed, hydrated and rested, your body heals itself (+2/h). Below 20 HP you cannot work. In this beta, collapse means hospitalization, medical bills/debt, and recovery time — permanent death stays disabled until that later system is approved.',
  },
]
