...
describe('FounderCovenantQueuePanel', () => {
  test('renders a passive founder covenant operator queue without execution controls', () => {
    ...
    expect(html).toContain('2 founders · 1 manual review · 1 overdue · 1 hospitalized · 1 indebted · 1 warning signal · 1 critical · $350 debt · more available')
    expect(html).toContain('Population proof</span><strong>1</strong>')
    expect(html).toContain('Contribution proof</span><strong>1</strong>')
    expect(html).toContain('Ideas proof</span><strong>1</strong>')
  ...
  test('renders an empty page as evidence-only review state', () => {
    ...
    expect(html).toContain('0 founders · 0 manual reviews · 0 overdue · 0 hospitalized · 0 indebted · 0 warning signals · 0 critical · $0 debt')
