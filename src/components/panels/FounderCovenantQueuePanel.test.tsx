...
describe('FounderCovenantQueuePanel', () => {
  test('renders a passive founder covenant operator queue without execution controls', () => {
    ...
    expect(html).toContain('2 founders · 14 activity signals: 2 met, 6 watch, 6 manual · 1 manual review · 1 overdue · 1 hospitalized · 1 indebted · $350 debt · more available')
  ...
  test('renders an empty page as evidence-only review state', () => {
    ...
    expect(html).toContain('0 founders · 0 activity signals: 0 met, 0 watch, 0 manual · 0 manual reviews · 0 overdue · 0 hospitalized · 0 indebted · $0 debt')
