...
describe('FounderCovenantQueuePanel', () => {
  test('renders a passive founder covenant operator queue without execution controls', () => {
    ...
    expect(html).toContain('2 founders · 1 manual review · 1 overdue · readiness: 1 blocked, 0 need evidence, 0 overdue, 0 ready, 1 monitoring · 1 hospitalized · 1 indebted · $350 debt · more available')
  ...
  test('renders an empty page as evidence-only review state', () => {
    ...
    expect(html).toContain('0 founders · 0 manual reviews · 0 overdue · readiness: 0 blocked, 0 need evidence, 0 overdue, 0 ready, 0 monitoring · 0 hospitalized · 0 indebted · $0 debt')
...
function founderQueue(): RealityFounderCovenantReviewQueueDashboard {
  ...
  const current = founderQueueItem({
    ...
    reviewReadiness: founderReviewReadiness({
      status: 'monitoring',
      label: 'Monitoring',
      summary: 'No manual review required yet.',
...
function founderReviewReadiness(
  overrides: Partial<RealityFounderCovenantReviewQueueItem['reviewReadiness']> = {},
