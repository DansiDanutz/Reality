        ...
        <span className="goals-card-agenda" aria-label={roadmapPreviewHeading(roadmapPreview.days.length - 1)}>
          ...
          {roadmapPreview.days.slice(1).map((day, index) => (
            <button
              ...
              aria-label={roadmapStageSummary(day.dayLabel, day.dayFocusLabel, day.millionaireStageLabel, day.primary.title, day.primary.minutes)}
            >
              ...
              <span>{day.millionaireStageStory}</span>
