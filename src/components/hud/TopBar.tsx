...
export default function TopBar() {
  ...
  const toggle = (id: 'shop' | 'work' | 'assets' | 'founder' | 'operator' | 'top' | 'profile' | 'achievements' | 'boxes' | 'construction') => setPanel(panel === id ? null : id)
  ...
  return (
    <header className="topbar">
      ...
      <nav className="topbar-nav" aria-label="Game menus">
        ...
        <button className={panel === 'construction' ? 'nav-btn active' : 'nav-btn'} onClick={() => toggle('construction')}>Build</button>
