# Reality — Beta Launch Kit

Positioning line (use everywhere):
> **A second Earth with a real economy. The first 2,000 founders get $200,000 to build it.**

Play link: https://reality-gamma.vercel.app · Repo: https://github.com/DansiDanutz/Reality
...
**2/** Why founders? Every player economy has a cold-start problem: someone has to build the first coffee shop before anyone can buy coffee.

So the first 2,000 citizens get real seed capital. After that, everyone starts with $2,500 and a job board. The land grab is real.

**3/** The beta is playable right now, free, in your browser. No account, no install.

▶ reality-gamma.vercel.app

**4/** And it's open source — clone it, run it, build the world with us. Contributions become part of the society: github.com/DansiDanutz/Reality

Founder slots for the online release are first come, first served. Waitlist is on the welcome screen.
...
## Product Hunt (hold until online release)

**Tagline:** Live a second life on a real Earth
**First comment:** the founder story + open-source angle. Launch when the real founder registry is live, so "claim your slot" converts on the spot.

## TikTok / Shorts script (15s)
...
- Week 1: X thread + both subreddits (stagger by a day, adapt to each community's rules)
- Ongoing: build-in-public dev-log posts per roadmap phase; every merged community PR is a post
- Convert everything to the waitlist; announce the founder-slot count milestone ("500 on the waitlist for 2,000 slots") as social proof
