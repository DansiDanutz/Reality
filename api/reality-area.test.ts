...
describe('reality area authority API', () => {
  ...
  test('operator founder covenant review returns a structured storage failure when pre-review catch-up cannot persist', async () => {
      .mockResolvedValueOnce(blobList([areaStatePath(CITIZEN_ID)], 'blob://stale-operator-review-area'))
