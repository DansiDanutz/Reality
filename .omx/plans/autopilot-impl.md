...
- Business-save compatibility hardening: migration now normalizes malformed business-development progress and worker-contract values to finite safe state while preserving legacy defaults.
...
- Daily handoff accessibility pass (2026-07-21): daily challenge live status, challenge progress labels, and Today/Journey primary action names now make completion and next-step routing explicit.
