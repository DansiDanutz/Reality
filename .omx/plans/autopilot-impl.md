...
- Next: run the dry-run/backfill operationally, add a live concurrent Postgres test, and move operator review/debt repayment fully onto the Postgres transaction boundary before broad flag enablement.
