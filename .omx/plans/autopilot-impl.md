...
- Next: run the dry-run/backfill operationally, add runtime cutover/concurrency tests, and move operator review/debt repayment fully onto the Postgres transaction boundary before broad flag enablement.
