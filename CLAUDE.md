...
- Client uses localStorage saves plus a live Postgres-backed `api/` layer (Vercel serverless, Neon). Server architecture is specified in `docs/ARCHITECTURE.md` — don't improvise a different one.
